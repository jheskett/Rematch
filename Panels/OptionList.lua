...
panel.opts = {
	...
	{ "check", "PetTrackerLetterBreeds", L["Show Breeds As H/P Not "]..PetTracker.Breeds:Icon(7,0.85)..newIcon, L["Rather than use icons for PetTracker's breeds, display breeds in the more standard letter format such as B/B, H/P, etc."], nil, true },
